...
//------------------------------------------------------------------------------
inline const q3Vec3
q3Mul(const q3Transform &tx, const q3Vec3 &scale, const q3Vec3 &v)
{
...
//------------------------------------------------------------------------------
inline const q3HalfSpace
q3Mul(const q3Transform &tx, const q3Vec3 &scale, const q3HalfSpace &p)
{
    q3Vec3 origin = p.Origin();
